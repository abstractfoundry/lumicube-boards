...
typedef enum
{
    ...
    CanardSTM32IfaceModeAutomaticTxAbortOnNack          //!< Abort pending TX if transmission was not acknowledged
...
typedef struct
{
    ...
    uint64_t error_count; // NOTE: these will occur when there are no other devices on the bus yet
} CanardSTM32Stats;
